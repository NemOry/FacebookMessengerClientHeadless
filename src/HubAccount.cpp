...
void HubAccount::initialize()
{
    ...
    if (!_initialized) {
        ...
        else
        {
            ...
            _udsUtil->updateAccount(_hubCache->accountId(), _displayName, _headlessTarget,
...
bool HubAccount::addHubItem(qint64 categoryId, QVariantMap &itemMap, QString name, QString subject, qint64 timestamp, QString itemSyncId,  QString itemUserData, QString itemExtendedData, bool notify)
{
    ...
    retVal = _udsUtil->addItem(_accountId, categoryId, itemMap, name, subject, _itemMimeType, _itemUnreadIconFilename, itemRead, itemSyncId, itemUserData, itemExtendedData, timestamp, itemContextState, notify);
